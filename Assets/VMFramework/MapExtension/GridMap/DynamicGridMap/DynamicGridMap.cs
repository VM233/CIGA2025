...
namespace VMFramework.Maps
{
    public abstract partial class DynamicGridMap : IGridMap
    {
        ...
        public IReadOnlyDictionary<Vector3Int, IGridChunk> Chunks => chunks;
        ...
        protected DynamicGridMap(DynamicGridMapConfig config, DynamicGridMapInitializationInfo info)
        {
            ...
            chunkCreatedEvent = GameItemManager.Instance.Get<GridChunkChangedEvent>(GridChunkChangedEventConfig.ID);
            chunkDestructedEvent = GameItemManager.Instance.Get<GridChunkChangedEvent>(GridChunkChangedEventConfig.ID);
        }
