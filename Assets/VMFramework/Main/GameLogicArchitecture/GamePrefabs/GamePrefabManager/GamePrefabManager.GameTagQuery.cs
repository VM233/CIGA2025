...
namespace VMFramework.GameLogicArchitecture
{
    public partial class GamePrefabManager
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void GetGamePrefabsByAllGameTags<TGamePrefab>(
            IReadOnlyCollection<string> gameTagIDs, [DisallowNull] ICollection<TGamePrefab> resultGamePrefabs)
