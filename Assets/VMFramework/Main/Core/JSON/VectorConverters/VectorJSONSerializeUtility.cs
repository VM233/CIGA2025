...
namespace VMFramework.Core.JSON
{
    public static class VectorJSONSerializeUtility
    {
        ...
        public static Vector2Int ReadVector2Int(this JsonReader reader)
        {
            ...
            if (value == null)
            {
                throw new JsonSerializationException($"Error deserializing Vector2Int. Value cannot be null.");
            }

            value = value.Trim(braces);
        ...
        public static Vector3Int ReadVector3Int(this JsonReader reader)
        {
            ...
            if (value == null)
            {
                throw new JsonSerializationException($"Error deserializing Vector3Int. Value cannot be null.");
            }
        ...
        public static Vector2 ReadVector2(this JsonReader reader)
        {
            ...
            if (value == null)
            {
                throw new JsonSerializationException($"Error deserializing Vector2. Value cannot be null.");
            }
        ...
        public static Vector3 ReadVector3(this JsonReader reader)
        {
            ...
            if (value == null)
            {
                throw new JsonSerializationException($"Error deserializing Vector3. Value cannot be null.");
            }
        ...
        public static Vector4 ReadVector4(this JsonReader reader)
        {
            ...
            if (value == null)
            {
                throw new JsonSerializationException($"Error deserializing Vector4. Value cannot be null.");
            }
        ...
        public static Color ReadColor(this JsonReader reader)
        {
            ...
            if (value == null)
            {
                throw new JsonSerializationException($"Error deserializing Color. Value cannot be null.");
            }
