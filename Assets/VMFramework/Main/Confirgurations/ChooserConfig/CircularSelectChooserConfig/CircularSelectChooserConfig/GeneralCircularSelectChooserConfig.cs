...
namespace VMFramework.Configuration
{
    ...
    public abstract partial class GeneralCircularSelectChooserConfig<TWrapper, TItem>
        : GeneralWrapperChooserConfig<TWrapper, TItem>, ICircularSelectChooserConfig<TWrapper, TItem>
    {
        ...
        private CircularSelectChooser<TItem> GenerateThisChooser()
        {
            return new CircularSelectChooser<TItem>(
                items.Select(item => new CircularSelectItem<TItem>(UnboxWrapper(item.value), item.times)), pingPong,
                startCircularIndex);
        }
