        ...
        where TGameEvent : IndependentGameEvent<TGameEvent>
    {
        ...
        public static void Enable()
        {
            if (disabledCount > 0)
            {
                ...
                if (disabledCount == 0)
                {
                    OnEnabledChangedEvent?.Invoke(null, false, true);
                }
            }
            else
            {
        ...
        public static void Disable()
        {
            ...
            if (disabledCount == 1)
            {
                OnEnabledChangedEvent?.Invoke(null, true, false);
            }
        }
        ...
        public static void AddCallback(Action<TGameEvent> callback, int priority = PriorityDefines.TINY)
        {
            if (callback == null)
            {
